...
<script>
    import ViewSingleItem from "../components/CartComponent";
    export default {
        name: "Stock",
        components: {ViewSingleItem},
        data: ()=>({
            items: [],
            loading: true,
            search: '',
            ...
            alertSuccess: false,
            successMessage: '',
            select_type: ['All', 'In Stock', 'Out of Stock'],
            filter_type: 'All',
        }),
        ...
        methods: {
            ...
            fetchItems(){
                ...
                else if (this.filter_type === 'In Stock'){
                    let data_ = {type: 'in'}
                    this.loading = true
                    let items = axios.post('item/index', data_).then((res)=>{
                        this.items = res.data['items']
                ...
                else if (this.filter_type === 'Out of Stock'){
                    let data_ = {type: 'out'}
                    this.loading = true
                    let items = axios.post('item/index', data_).then((res)=>{
                        this.items = res.data['items']
